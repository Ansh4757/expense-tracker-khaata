...
-- Dumping data for table expense_tracker.expenses: ~117 rows (approximately)
...
-- Dumping data for table expense_tracker.password_reset_token: ~40 rows (approximately)
...
-- Dumping data for table expense_tracker.users: ~91 rows (approximately)
